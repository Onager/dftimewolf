...
L2TBINARIES_DEPENDENCIES="bs4 certifi chardet grr_api_client idna pytz requests urllib3";

L2TBINARIES_TEST_DEPENDENCIES="funcsigs mock pbr six";

PYTHON2_DEPENDENCIES="python-bs4 python-certifi python-chardet python-grr-api-client python-idna python-requests python-tz python-urllib3";

PYTHON2_TEST_DEPENDENCIES="python-coverage python-mock python-tox";

PYTHON3_DEPENDENCIES="python3-bs4 python3-certifi python3-chardet python3-grr-api-client python3-idna python3-requests python3-tz python3-urllib3";
